...
`{ctypesio}` provides functions for reading/writing standard C types from connections.
...
You can install from [GitHub](https://github.com/coolbutuseless/ctypesio) with:
